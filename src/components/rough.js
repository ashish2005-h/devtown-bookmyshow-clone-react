                ...
                <Row style={{textAlign: "center"}}>
                    <Col xs={6} md={4} lg={3} style={{marginBottom:"7%"}}>
                        <Card style={{height:"335px", width:"200px"}}>
                            <Card.Img src="https://ottraja.com/wp-content/uploads/2022/01/Nay-Varan-Bhat-Loncha-Kon-Nay-Koncha-Movie-OTT-Rights.webp" alt="Card image" style={{height:"335px", width:"200px", alignSelf:"center"}}/>
                            <Card.Body>
